        ...
        switch(page) {
            ...
            case "Collaborators.fxml" -> {
                ...
                buttonAddCollaborator.setOnMouseClicked(event2 -> {
                    TemplateViewModel.trocarDeTela("RegisterCollaborator.fxml");
            ...
            case "Goals.fxml" -> {
                ...
                buttonAddGoal.setOnMouseClicked(event2 -> TemplateViewModel.trocarDeTela("PersonalGoal.fxml"));
    ...
    public void buildHeaderStructure(boolean returnButton, String label, Node... headerItems) {
        ...
        if (returnButton){
            ...
            returnBtn.setOnMouseClicked(event -> {
                ...
                TemplateViewModel.trocarDeTela(pageHistory[0]);
            });
        }
